...
precision=1.2; //espace entre interieur enclosure du haut et exterieur enclosure du bas.  (1 = .5 de chaque cote)
...
translate([2*longueur+5,0,0])
    difference(){
        ...
        translate([-longueur/2-2,+4,1])rotate([180,0,0])linear_extrude(3,center=true) text(prenom,8);
    }
...
translate([21,0,0])
    ...
    translate([-longueur/2-1,4,1])rotate([180,0,0])linear_extrude(3,center=true) text(prenom,8);
}
